...
export default {
  ...
  "lobby.workshop": "体验室",
  "jump.up": "向上{steps}步",
  "jump.upRight": "向右上{steps}步",
  "jump.right": "向右{steps}步",
  "jump.downRight": "向右下{steps}步",
  "jump.down": "向下{steps}步",
  "jump.downLeft": "向左下{steps}步",
  "jump.left": "向左{steps}步",
  "jump.upLeft": "向左上{steps}步",
  "minimap.mode": "切换地图显示",
  "minimap.mode.colour": "画作色彩",
  "minimap.mode.rooms": "展厅",
  "minimap.out": "看得更广",
  "minimap.in": "看得更近",
  ...
  "pamphlet.lobby": "一层大厅",
  "floor.lobby": "大厅",
  "pamphlet.lobbyNote": "大厅里有美术馆的标志、今日之画和体验室。",
  "pamphlet.toLobby": "前往大厅",
  "pamphlet.toWorkshop": "前往体验室",
  "lobby.qr": "制作二维码",
  "lobby.exit": "回到大厅",
