...
export default {
  ...
  "jump.up": "{steps} steps up",
  "jump.upRight": "{steps} steps up and right",
  "jump.right": "{steps} steps right",
  "jump.downRight": "{steps} steps down and right",
  "jump.down": "{steps} steps down",
  "jump.downLeft": "{steps} steps down and left",
  "jump.left": "{steps} steps left",
  "jump.upLeft": "{steps} steps up and left",
