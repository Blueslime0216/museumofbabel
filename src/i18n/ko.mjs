...
export default {
  ...
  "lobby.workshop": "체험관",
  "jump.up": "위로 {steps}걸음",
  "jump.upRight": "오른쪽 위로 {steps}걸음",
  "jump.right": "오른쪽으로 {steps}걸음",
  "jump.downRight": "오른쪽 아래로 {steps}걸음",
  "jump.down": "아래로 {steps}걸음",
  "jump.downLeft": "왼쪽 아래로 {steps}걸음",
  "jump.left": "왼쪽으로 {steps}걸음",
  "jump.upLeft": "왼쪽 위로 {steps}걸음",
