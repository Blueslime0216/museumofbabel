...
const HUES = {
  ...
  ru: [
    ...
    'Янтарь', 'Охра', 'Олива', 'Медянка', 'Селадон', 'Бирюза',
  ],
};
...
const NEUTRALS = {
  ...
  ja: ['煤色', '墨', '青鈍', '錫色', '灰', '生成', '象牙', '白磁'],
  zh: ['煤黑', '焦墨', '石板灰', '白锡', '烟灰', '骨白', '象牙', '垩白'],
...
const ADJECTIVES = {
  ...
  zh: [
    ...
    '断裂的', '站立的', '坠落的', '重叠的', '中空的', '稠密的', '浅的', '迟的',
    '早的', '未完的', '临时的', '执拗的', '沉默的', '分开的', '内嵌的', '翻转的',
...
const NOUNS = {
  ...
  ja: [
    '野', '通路', '間', '段', '閾', '隙', '層', '律',
    '仕切り', '格子', '廊', '断片', '余白', '囲い', '子午線', '順',
    '室', '玄関', '台地', '台帳', '壁面', '柱', '書庫', '軒',
    '壁龕', '水槽', '城壁', '柱廊', '柵', '聖遺物箱', '別館', '円堂',
  ],
  zh: [
    '野', '通道', '间隔', '台', '门槛', '缝', '层', '韵',
    '隔断', '格栅', '走廊', '碎片', '留白', '围栏', '子午线', '序列',
    '室', '前厅', '高台', '账册', '立面', '柱', '书库', '檐',
  ...
  ru: [
    ...
    'Простенок', 'Переплёт', 'Коридор', 'Фрагмент', 'Отступ', 'Предел', 'Меридиан', 'Ряд',
    'Покой', 'Вестибюль', 'Ярус', 'Реестр', 'Фасад', 'Столб', 'Архив', 'Карниз',
    'Альков', 'Водоём', 'Вал', 'Портик', 'Частокол', 'Ковчег', 'Флигель', 'Зал',
  ],
};
